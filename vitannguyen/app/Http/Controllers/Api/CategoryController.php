...
{  
    ...
    public function destroy($id){
        $category = Category::find($id);
       if($category==null){
        return response()->json( ['message'=>'tai ko dc','success'=>false,'category'=>null],
            404
        );
       }
    ...
    $category->delete();
    return response()->json(['message'=>'tai dc','success'=>true,'id'=>$category],
    ...
    public function category_list($parent_id=0){
        ...
        $categorys = Category::where($args)->orderBy('sort_order','ASC')->get();
        return response()->json(['success'=>true,
        'message'=>'tai du lieu thanh cong',
        'categorys'=>$categorys],200);
    }
}